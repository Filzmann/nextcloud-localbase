...
if (in_array((string)$info->version, ['0.7.0-rc.2', '0.7.0-rc.3'], true)) throw new RuntimeException('Geänderte Admin-Assets verwenden weiterhin einen bereits langfristig gecachten App-Versionsschlüssel.');
