...
$assert(true, $policy->canManage('stv-pdl', false, ['ad-StvPDL'], 'pfk', ['ad-PFK']), 'Stv. PDL muss Pflegefachkräfte verwalten dürfen.');
$assert(true, $policy->canManage('stv-pdl', false, ['ad-StvPDL'], 'pflegebuero', ['ad-Bueroorganisation-Pflege']), 'Stv. PDL muss Büroorganisation Pflege verwalten dürfen.');
$assert(true, $policy->canManage('gf-digi', false, ['ad-GF-Digi'], 'fuhrpark', ['ad-Fahrzeugverwaltung']), 'GF-Digi muss Fahrzeugverwaltung verwalten dürfen.');
$assert(true, $policy->canManage('sekretariat', false, ['ad-Sekretariat'], 'empfang', ['ad-Empfang']), 'Sekretariat muss Empfang verwalten dürfen.');
$assert(false, $policy->canManage('empfang', false, ['ad-Empfang'], 'sekretariat', ['ad-Sekretariat']), 'Empfang darf das Sekretariat nicht verwalten.');
