...
final class AdDemoFixtureCatalog {
    ...
    private static function fixtures(): array {
        return [
            ...
            ['uid' => 'ad-demo-stvpdl', 'displayName' => 'Pia Neumann (Stv. PDL)', 'roles' => ['deputy_pdl'], 'areas' => []],
            ['uid' => 'ad-demo-pflegebuero', 'displayName' => 'Bela Krämer (Büroorganisation Pflege)', 'roles' => ['care_office'], 'areas' => []],
            ...
            ['uid' => 'ad-demo-finanzen', 'displayName' => 'Finn Lohmann (Finanzen)', 'roles' => ['finance'], 'areas' => []],
            ['uid' => 'ad-demo-lohn', 'displayName' => 'Luca Hoffmann (Lohn)', 'roles' => ['payroll'], 'areas' => []],
            ['uid' => 'ad-demo-it', 'displayName' => 'Imani Teich (IT)', 'roles' => ['it'], 'areas' => []],
            ['uid' => 'ad-demo-fahrzeugverwaltung', 'displayName' => 'Fatima Wagner (Fahrzeugverwaltung)', 'roles' => ['fleet_management'], 'areas' => []],
            ['uid' => 'ad-demo-sekretariat', 'displayName' => 'Samira König (Sekretariat)', 'roles' => ['secretariat'], 'areas' => []],
            ['uid' => 'ad-demo-empfang', 'displayName' => 'Eleni Schubert (Empfang)', 'roles' => ['reception'], 'areas' => []],
