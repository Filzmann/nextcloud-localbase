...
final class ScheduleConflictQueryEvent extends Event {
    ...
    public function __construct(private string $employeeUid, private DateTimeImmutable $start, private DateTimeImmutable $end) { parent::__construct(); if ($employeeUid === '' || $start >= $end) throw new InvalidArgumentException('Ungueltige Konfliktabfrage.'); }
